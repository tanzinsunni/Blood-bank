						  ...
						  <div   class="col span_2_of_3"> 
							  <div class="contact-form" style="padding-left:100px;">
								...
								<table  cellspacing="0" cellpadding="0"  width="500px" height="300px">               
									...
									<tr><td class="lefttd"  style="vertical-align:middle">Mobile No:</td><td><input type="text" pattern="[0-9]{10,12}" name="t3" title="please enter only numbers between 10 to 12 for mobile no." /></td></tr>
