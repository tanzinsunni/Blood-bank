...
<title>LifeStream Service</title>
...
<body>
	<div class="h_bg">
		<div class="wrap">
			<div class="header">
					<div class="logo">
						<a href="index.php"><img src="Images/logo1.PNG" alt=""></a></h1>
					</div>
			</div>
		</div>
	</div>
        ...
        <div>
			...
			<div class="s_bg">
				...
				<div class="main">
					<div class="content">		
							<h4>LifeStream Services:</h4>
							<p> We welcome you to in our Website. If you are a donor , We appreciate you <a href="registration.php">signing up</a> online as a Donor. If you need blood we are happy to serve you. This blood donor list is hosted by <a href="index.php">www.lifestream.com</a> on behalf of "LifeStream Servicesp Blood Bank"
