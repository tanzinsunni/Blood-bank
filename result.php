		 ...
		 <form method="post" enctype="multipart/form-data">
			  <table cellpadding="0" cellspacing="0" width="1000px" style="margin:auto">
			   <tr>            
				...
				<table cellpadding="0" cellspacing="0" width="800px" height="1000" style="margin:auto; border:0px" class="tableborder">
		   ...
		   ?>
               ...
               <div class="clear"></div>
<div class="ftr-bg">
	<div class="wrap" style="margin-bottom:0px !important;">
